...
import { Scale, Menu, X, MessageSquare, BookOpen, Activity, LayoutGrid } from 'lucide-react'
        ...
        <div className="flex h-[65px] items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group transition-opacity hover:opacity-90">
            ...
            <div className="leading-none">
              <span className="font-serif text-[17px] text-[#f0ece3] block">LegalEase</span>
              <span className="text-[9px] font-medium text-[#c9a96e] tracking-[2px] uppercase mt-0.5 block">AI Platform</span>
            </div>
          </Link>
